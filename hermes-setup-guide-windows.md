# Hermes Agent Setup Guide — Windows PC (WSL2)
...
### Step 2.2 — Make sure you're on WSL2
...
### Step 2.3 — Enable systemd (important for later)
...
In the Ubuntu terminal, run ONE of these depending on which provider you chose:
